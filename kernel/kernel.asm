...
freemem(void)
{
    ...
    80000190:	046080e7          	jalr	70(ra) # 800061d2 <acquire>
    r = kmem.freelist;
    ...
    800001ac:	0de080e7          	jalr	222(ra) # 80006286 <release>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    800003aa:	92c080e7          	jalr	-1748(ra) # 80005cd2 <printf>
    ...
    800003c2:	da2080e7          	jalr	-606(ra) # 80005160 <plicinithart>
  }
  ...
  scheduler();        
    ...
    80000442:	d0c080e7          	jalr	-756(ra) # 8000514a <plicinit>
    plicinithart();  // ask PLIC for device interrupts
    80000446:	00005097          	auipc	ra,0x5
    8000044a:	d1a080e7          	jalr	-742(ra) # 80005160 <plicinithart>
    binit();         // buffer cache
    8000044e:	00002097          	auipc	ra,0x2
    80000452:	ef6080e7          	jalr	-266(ra) # 80002344 <binit>
    iinit();         // inode table
    80000456:	00002097          	auipc	ra,0x2
    8000045a:	586080e7          	jalr	1414(ra) # 800029dc <iinit>
    fileinit();      // file table
    8000045e:	00003097          	auipc	ra,0x3
    80000462:	530080e7          	jalr	1328(ra) # 8000398e <fileinit>
    virtio_disk_init(); // emulated hard disk
    80000466:	00005097          	auipc	ra,0x5
    8000046a:	e1c080e7          	jalr	-484(ra) # 80005282 <virtio_disk_init>
    userinit();      // first user process
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    800004dc:	7b0080e7          	jalr	1968(ra) # 80005c88 <panic>
...
0000000080000632 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000065e:	62e080e7          	jalr	1582(ra) # 80005c88 <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    800008b8:	3d4080e7          	jalr	980(ra) # 80005c88 <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    800009fa:	292080e7          	jalr	658(ra) # 80005c88 <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b50:	13c080e7          	jalr	316(ra) # 80005c88 <panic>
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000db2:	eda080e7          	jalr	-294(ra) # 80005c88 <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000dde:	368080e7          	jalr	872(ra) # 80006142 <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000df6:	350080e7          	jalr	848(ra) # 80006142 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000e2c:	31a080e7          	jalr	794(ra) # 80006142 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000ea0:	2ea080e7          	jalr	746(ra) # 80006186 <push_off>
  ...
  pop_off();
    ...
    80000eba:	370080e7          	jalr	880(ra) # 80006226 <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000ede:	3ac080e7          	jalr	940(ra) # 80006286 <release>

  if (first) {
    80000ee2:	00008797          	auipc	a5,0x8
    80000ee6:	abe7a783          	lw	a5,-1346(a5) # 800089a0 <first.1677>
  ...
  usertrapret();
    ...
    80000f00:	aa07a223          	sw	zero,-1372(a5) # 800089a0 <first.1677>
    fsinit(ROOTDEV);
    80000f04:	4505                	li	a0,1
    80000f06:	00002097          	auipc	ra,0x2
    80000f0a:	a56080e7          	jalr	-1450(ra) # 8000295c <fsinit>
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000f2a:	2ac080e7          	jalr	684(ra) # 800061d2 <acquire>
  pid = nextpid;
  ...
  release(&pid_lock);
    ...
    80000f44:	346080e7          	jalr	838(ra) # 80006286 <release>
}
...
000000008000109c <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800010be:	118080e7          	jalr	280(ra) # 800061d2 <acquire>
    if(p->state == UNUSED) {
    ...
    800010cc:	1be080e7          	jalr	446(ra) # 80006286 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    8000114a:	140080e7          	jalr	320(ra) # 80006286 <release>
    return 0;
    ...
    80001162:	128080e7          	jalr	296(ra) # 80006286 <release>
    return 0;
...
000000008000116a <userinit>:
{
  ...
  p->cwd = namei("/");
    ...
    800011cc:	1c2080e7          	jalr	450(ra) # 8000338a <namei>
  ...
  release(&p->lock);
    ...
    800011de:	0ac080e7          	jalr	172(ra) # 80006286 <release>
}
...
0000000080001260 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    800012f6:	f94080e7          	jalr	-108(ra) # 80006286 <release>
    return -1;
    800012fa:	5a7d                	li	s4,-1
    800012fc:	a849                	j	8000138e <fork+0x12e>
      np->ofile[i] = filedup(p->ofile[i]);
    800012fe:	00002097          	auipc	ra,0x2
    80001302:	722080e7          	jalr	1826(ra) # 80003a20 <filedup>
  ...
  np->cwd = idup(p->cwd);
    ...
    80001324:	876080e7          	jalr	-1930(ra) # 80002b96 <idup>
  ...
  release(&np->lock);
    ...
    8000138a:	f00080e7          	jalr	-256(ra) # 80006286 <release>
}
...
00000000800013a4 <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001426:	e64080e7          	jalr	-412(ra) # 80006286 <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001438:	d9e080e7          	jalr	-610(ra) # 800061d2 <acquire>
      if(p->state == RUNNABLE) {
...
0000000080001444 <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    80001460:	cfc080e7          	jalr	-772(ra) # 80006158 <holding>
...
000000008000151a <yield>:
{
  ...
  acquire(&p->lock);
    ...
    80001532:	ca4080e7          	jalr	-860(ra) # 800061d2 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    80001548:	d42080e7          	jalr	-702(ra) # 80006286 <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    80001576:	c60080e7          	jalr	-928(ra) # 800061d2 <acquire>
  release(lk);
    8000157a:	854a                	mv	a0,s2
    8000157c:	00005097          	auipc	ra,0x5
    80001580:	d0a080e7          	jalr	-758(ra) # 80006286 <release>
  ...
  release(&p->lock);
    ...
    8000159e:	cec080e7          	jalr	-788(ra) # 80006286 <release>
  acquire(lk);
    800015a2:	854a                	mv	a0,s2
    800015a4:	00005097          	auipc	ra,0x5
    800015a8:	c2e080e7          	jalr	-978(ra) # 800061d2 <acquire>
}
...
00000000800015ba <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800015ea:	bec080e7          	jalr	-1044(ra) # 800061d2 <acquire>
    havekids = 0;
    ...
    80001688:	b4e080e7          	jalr	-1202(ra) # 800061d2 <acquire>
        if(np->state == ZOMBIE){
    ...
    80001698:	bf2080e7          	jalr	-1038(ra) # 80006286 <release>
        havekids = 1;
    ...
    800016b4:	bd6080e7          	jalr	-1066(ra) # 80006286 <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001716:	b74080e7          	jalr	-1164(ra) # 80006286 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001734:	aa2080e7          	jalr	-1374(ra) # 800061d2 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
00000000800017b2 <exit>:
{
  ...
  if(p == initproc)
    ...
    800017ee:	49e080e7          	jalr	1182(ra) # 80005c88 <panic>
      fileclose(f);
    800017f2:	00002097          	auipc	ra,0x2
    800017f6:	280080e7          	jalr	640(ra) # 80003a72 <fileclose>
      p->ofile[fd] = 0;
  ...
  begin_op();
    ...
    8000180e:	d9c080e7          	jalr	-612(ra) # 800035a6 <begin_op>
  iput(p->cwd);
    80001812:	1509b503          	ld	a0,336(s3)
    80001816:	00001097          	auipc	ra,0x1
    8000181a:	578080e7          	jalr	1400(ra) # 80002d8e <iput>
  end_op();
    8000181e:	00002097          	auipc	ra,0x2
    80001822:	e08080e7          	jalr	-504(ra) # 80003626 <end_op>
  p->cwd = 0;
  ...
  acquire(&wait_lock);
    ...
    80001838:	99e080e7          	jalr	-1634(ra) # 800061d2 <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    80001858:	97e080e7          	jalr	-1666(ra) # 800061d2 <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    8000186c:	a1e080e7          	jalr	-1506(ra) # 80006286 <release>
  sched();
  ...
  panic("zombie exit");
    ...
    80001884:	408080e7          	jalr	1032(ra) # 80005c88 <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800018ae:	928080e7          	jalr	-1752(ra) # 800061d2 <acquire>
    if(p->pid == pid){
    ...
    800018be:	9cc080e7          	jalr	-1588(ra) # 80006286 <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    800018e0:	9aa080e7          	jalr	-1622(ra) # 80006286 <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    800019c8:	30e080e7          	jalr	782(ra) # 80005cd2 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a0a:	2cc080e7          	jalr	716(ra) # 80005cd2 <printf>
    printf("\n");
    80001a0e:	8552                	mv	a0,s4
    80001a10:	00004097          	auipc	ra,0x4
    80001a14:	2c2080e7          	jalr	706(ra) # 80005cd2 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
nproc(void)
{
    ...
    80001a7a:	75c080e7          	jalr	1884(ra) # 800061d2 <acquire>
        if (p->state != UNUSED) {
    ...
    80001a8c:	7fe080e7          	jalr	2046(ra) # 80006286 <release>
    for (p = proc; p < &proc[NPROC]; p++) {
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001b2e:	618080e7          	jalr	1560(ra) # 80006142 <initlock>
}
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80001b44:	55078793          	addi	a5,a5,1360 # 80005090 <kernelvec>
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001c08:	5ce080e7          	jalr	1486(ra) # 800061d2 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001c28:	662080e7          	jalr	1634(ra) # 80006286 <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c6c:	530080e7          	jalr	1328(ra) # 80005198 <plic_claim>
    ...
    80001c90:	046080e7          	jalr	70(ra) # 80005cd2 <printf>
      plic_complete(irq);
    80001c94:	8526                	mv	a0,s1
    80001c96:	00003097          	auipc	ra,0x3
    80001c9a:	526080e7          	jalr	1318(ra) # 800051bc <plic_complete>
    return 1;
    80001c9e:	4505                	li	a0,1
    80001ca0:	bf55                	j	80001c54 <devintr+0x1e>
      uartintr();
    80001ca2:	00004097          	auipc	ra,0x4
    80001ca6:	450080e7          	jalr	1104(ra) # 800060f2 <uartintr>
    80001caa:	b7ed                	j	80001c94 <devintr+0x5e>
      virtio_disk_intr();
    80001cac:	00004097          	auipc	ra,0x4
    80001cb0:	9f0080e7          	jalr	-1552(ra) # 8000569c <virtio_disk_intr>
...
0000000080001cd8 <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80001cf2:	3a278793          	addi	a5,a5,930 # 80005090 <kernelvec>
  ...
  usertrapret();
    ...
    80001d5a:	f32080e7          	jalr	-206(ra) # 80005c88 <panic>
      exit(-1);
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001d8e:	f48080e7          	jalr	-184(ra) # 80005cd2 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001da6:	f30080e7          	jalr	-208(ra) # 80005cd2 <printf>
    p->killed = 1;
...
0000000080001dcc <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001e26:	e66080e7          	jalr	-410(ra) # 80005c88 <panic>
    ...
    80001e36:	e56080e7          	jalr	-426(ra) # 80005c88 <panic>
    printf("scause %p\n", scause);
    ...
    80001e48:	e8e080e7          	jalr	-370(ra) # 80005cd2 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001efc:	d90080e7          	jalr	-624(ra) # 80005c88 <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002076:	31e50513          	addi	a0,a0,798 # 80008390 <states.1714+0x150>
    8000207a:	00004097          	auipc	ra,0x4
    8000207e:	c58080e7          	jalr	-936(ra) # 80005cd2 <printf>
    ...
    80002090:	31c50513          	addi	a0,a0,796 # 800083a8 <states.1714+0x168>
    80002094:	00004097          	auipc	ra,0x4
    80002098:	c3e080e7          	jalr	-962(ra) # 80005cd2 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    800021c0:	016080e7          	jalr	22(ra) # 800061d2 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    80002214:	076080e7          	jalr	118(ra) # 80006286 <release>
  return 0;
    ...
    80002236:	054080e7          	jalr	84(ra) # 80006286 <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002286:	f50080e7          	jalr	-176(ra) # 800061d2 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    8000229e:	fec080e7          	jalr	-20(ra) # 80006286 <release>
  return xticks;
}
...
sys_trace(void)
{
  ...
  if (argint(0, &mask) < 0) {
    800022ca:	00054a63          	bltz	a0,800022de <sys_trace+0x2c>
  }
    
  myproc()->trace_mask = mask;
    800022ce:	fffff097          	auipc	ra,0xfffff
    800022d2:	bc4080e7          	jalr	-1084(ra) # 80000e92 <myproc>
    800022d6:	fec42783          	lw	a5,-20(s0)
    800022da:	d95c                	sw	a5,52(a0)
...
sys_sysinfo(void)
{
    ...
    if (argaddr(0, &addr) < 0)
    800022f0:	fd840593          	addi	a1,s0,-40
    800022f4:	4501                	li	a0,0
    800022f6:	00000097          	auipc	ra,0x0
    800022fa:	cc6080e7          	jalr	-826(ra) # 80001fbc <argaddr>
    800022fe:	87aa                	mv	a5,a0
        return -1;
    80002300:	557d                	li	a0,-1
    if (argaddr(0, &addr) < 0)
    80002302:	0207cd63          	bltz	a5,8000233c <sys_sysinfo+0x54>
    
    info.freemem = freemem();
    80002306:	ffffe097          	auipc	ra,0xffffe
    8000230a:	e72080e7          	jalr	-398(ra) # 80000178 <freemem>
    8000230e:	fea43023          	sd	a0,-32(s0)
    info.nproc = nproc();
    80002312:	fffff097          	auipc	ra,0xfffff
    80002316:	742080e7          	jalr	1858(ra) # 80001a54 <nproc>
    8000231a:	fea43423          	sd	a0,-24(s0)
    
    struct proc *p = myproc();
    8000231e:	fffff097          	auipc	ra,0xfffff
    80002322:	b74080e7          	jalr	-1164(ra) # 80000e92 <myproc>
    if (copyout(p->pagetable, addr, (char *)&info, sizeof(info)) < 0)
    80002326:	46c1                	li	a3,16
    80002328:	fe040613          	addi	a2,s0,-32
    8000232c:	fd843583          	ld	a1,-40(s0)
    80002330:	6928                	ld	a0,80(a0)
    80002332:	fffff097          	auipc	ra,0xfffff
    80002336:	822080e7          	jalr	-2014(ra) # 80000b54 <copyout>
    8000233a:	957d                	srai	a0,a0,0x3f
        return -1;
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002358:	2bc58593          	addi	a1,a1,700 # 80008610 <syscall_names+0xc0>
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    ...
    80002394:	288a0a13          	addi	s4,s4,648 # 80008618 <syscall_names+0xc8>
    b->next = bcache.head.next;
...
bread(uint dev, uint blockno)
{
  ...
  panic("bget: no buffers");
    ...
    80002466:	1be50513          	addi	a0,a0,446 # 80008620 <syscall_names+0xd0>
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    800024f6:	14650513          	addi	a0,a0,326 # 80008638 <syscall_names+0xe8>
...
brelse(struct buf *b)
{
  ...
  release(&bcache.lock);
    ...
    80002594:	0b050513          	addi	a0,a0,176 # 80008640 <syscall_names+0xf0>
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    80002688:	fc450513          	addi	a0,a0,-60 # 80008648 <syscall_names+0xf8>
...
0000000080002694 <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    8000274e:	f1650513          	addi	a0,a0,-234 # 80008660 <syscall_names+0x110>
  ...
  memset(bp->data, 0, BSIZE);
    ...
    80002792:	a34080e7          	jalr	-1484(ra) # 800001c2 <memset>
  log_write(bp);
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    80002894:	de850513          	addi	a0,a0,-536 # 80008678 <syscall_names+0x128>
...
00000000800028a0 <iget>:
{
  ...
  release(&itable.lock);
    ...
    80002950:	d4450513          	addi	a0,a0,-700 # 80008690 <syscall_names+0x140>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    8000298e:	898080e7          	jalr	-1896(ra) # 80000222 <memmove>
  brelse(bp);
  ...
  initlog(dev, &sb);
    ...
    800029d0:	cd450513          	addi	a0,a0,-812 # 800086a0 <syscall_names+0x150>
...
00000000800029dc <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    800029ee:	cce58593          	addi	a1,a1,-818 # 800086b8 <syscall_names+0x168>
  ...
  for(i = 0; i < NINODE; i++) {
    ...
    80002a16:	cae90913          	addi	s2,s2,-850 # 800086c0 <syscall_names+0x170>
...
0000000080002a3c <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    80002ab4:	c1850513          	addi	a0,a0,-1000 # 800086c8 <syscall_names+0x178>
    ...
    80002acc:	6fa080e7          	jalr	1786(ra) # 800001c2 <memset>
      dip->type = type;
...
0000000080002b0a <iupdate>:
{
  ...
  memmove(dip->addrs, ip->addrs, sizeof(ip->addrs));
    ...
    80002b72:	6b4080e7          	jalr	1716(ra) # 80000222 <memmove>
  log_write(bp);
...
0000000080002bd4 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002c08:	adc50513          	addi	a0,a0,-1316 # 800086e0 <syscall_names+0x190>
    ...
    80002c6e:	5b8080e7          	jalr	1464(ra) # 80000222 <memmove>
    brelse(bp);
    ...
    80002c8a:	a6250513          	addi	a0,a0,-1438 # 800086e8 <syscall_names+0x198>
...
0000000080002c96 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002cd6:	a2650513          	addi	a0,a0,-1498 # 800086f8 <syscall_names+0x1a8>
    ...
    80002e8a:	0ed7e963          	bltu	a5,a3,80002f7c <readi+0xf4>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    80002eec:	a12080e7          	jalr	-1518(ra) # 800018fa <either_copyout>
    ...
    80002f82:	10d7e863          	bltu	a5,a3,80003092 <writei+0x112>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    80002fe4:	970080e7          	jalr	-1680(ra) # 80001950 <either_copyin>
...
namecmp(const char *s, const char *t)
{
  ...
  return strncmp(s, t, DIRSIZ);
    ...
    800030ac:	1f2080e7          	jalr	498(ra) # 8000029a <strncmp>
}
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800030e6:	61e50513          	addi	a0,a0,1566 # 80008700 <syscall_names+0x1b0>
    800030ea:	00003097          	auipc	ra,0x3
    800030ee:	b9e080e7          	jalr	-1122(ra) # 80005c88 <panic>
      panic("dirlookup read");
    800030f2:	00005517          	auipc	a0,0x5
    800030f6:	62650513          	addi	a0,a0,1574 # 80008718 <syscall_names+0x1c8>
...
namex(char *path, int nameiparent, char *name)
{
  ...
  if(*path == '/')
    ...
    80003198:	cfe080e7          	jalr	-770(ra) # 80000e92 <myproc>
  ...
  if(len >= DIRSIZ)
    ...
    8000321c:	00a080e7          	jalr	10(ra) # 80000222 <memmove>
  while(*path == '/')
  ...
  while(*path != '/' && *path != 0)
    ...
    800032a0:	f86080e7          	jalr	-122(ra) # 80000222 <memmove>
    name[len] = 0;
...
00000000800032c8 <dirlink>:
{
  ...
  strncpy(de.name, name, DIRSIZ);
    ...
    80003328:	fb2080e7          	jalr	-78(ra) # 800002d6 <strncpy>
  de.inum = inum;
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    8000336e:	3be50513          	addi	a0,a0,958 # 80008728 <syscall_names+0x1d8>
    80003372:	00003097          	auipc	ra,0x3
    80003376:	916080e7          	jalr	-1770(ra) # 80005c88 <panic>
    panic("dirlink");
    8000337a:	00005517          	auipc	a0,0x5
    8000337e:	4b650513          	addi	a0,a0,1206 # 80008830 <syscall_names+0x2e0>
    ...
    80003446:	0af05d63          	blez	a5,80003500 <install_trans+0xc2>
{
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800034d8:	d4e080e7          	jalr	-690(ra) # 80000222 <memmove>
...
0000000080003502 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003520:	21c58593          	addi	a1,a1,540 # 80008738 <syscall_names+0x1e8>
...
begin_op(void)
{
  ...
  while(1){
    ...
    800035d6:	f84080e7          	jalr	-124(ra) # 80001556 <sleep>
    if(log.committing){
    ...
    80003602:	f58080e7          	jalr	-168(ra) # 80001556 <sleep>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80003694:	052080e7          	jalr	82(ra) # 800016e2 <wakeup>
    release(&log.lock);
    ...
    800036b8:	08c50513          	addi	a0,a0,140 # 80008740 <syscall_names+0x1f0>
    ...
    800036d2:	014080e7          	jalr	20(ra) # 800016e2 <wakeup>
  release(&log.lock);
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    8000372c:	afa080e7          	jalr	-1286(ra) # 80000222 <memmove>
...
log_write(struct buf *b)
{
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80003812:	f4250513          	addi	a0,a0,-190 # 80008750 <syscall_names+0x200>
    80003816:	00002097          	auipc	ra,0x2
    8000381a:	472080e7          	jalr	1138(ra) # 80005c88 <panic>
    panic("log_write outside of trans");
    8000381e:	00005517          	auipc	a0,0x5
    80003822:	f4a50513          	addi	a0,a0,-182 # 80008768 <syscall_names+0x218>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80003878:	f1458593          	addi	a1,a1,-236 # 80008788 <syscall_names+0x238>
...
acquiresleep(struct sleeplock *lk)
{
  ...
  while (lk->locked) {
    ...
    800038c6:	c94080e7          	jalr	-876(ra) # 80001556 <sleep>
  while (lk->locked) {
  ...
  lk->pid = myproc()->pid;
    ...
    800038d6:	5c0080e7          	jalr	1472(ra) # 80000e92 <myproc>
...
releasesleep(struct sleeplock *lk)
{
  ...
  wakeup(lk);
    ...
    8000391e:	dc8080e7          	jalr	-568(ra) # 800016e2 <wakeup>
  release(&lk->lk);
...
holdingsleep(struct sleeplock *lk)
{
  ...
  r = lk->locked && (lk->pid == myproc()->pid);
    ...
    8000397e:	518080e7          	jalr	1304(ra) # 80000e92 <myproc>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    8000399a:	e0258593          	addi	a1,a1,-510 # 80008798 <syscall_names+0x248>
...
filedup(struct file *f)
{
  ...
  return f;
    ...
    80003a66:	d3e50513          	addi	a0,a0,-706 # 800087a0 <syscall_names+0x250>
...
fileclose(struct file *f)
{
  ...
  if(ff.type == FD_PIPE){
    ...
    80003afe:	cae50513          	addi	a0,a0,-850 # 800087a8 <syscall_names+0x258>
...
filestat(struct file *f, uint64 addr)
{
  ...
  struct proc *p = myproc();
    ...
    80003b50:	346080e7          	jalr	838(ra) # 80000e92 <myproc>
  struct stat st;
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    80003b92:	fc6080e7          	jalr	-58(ra) # 80000b54 <copyout>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003c56:	b6650513          	addi	a0,a0,-1178 # 800087b8 <syscall_names+0x268>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  return ret;
    ...
    80003d8a:	a4250513          	addi	a0,a0,-1470 # 800087c8 <syscall_names+0x278>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003dfa:	5ea58593          	addi	a1,a1,1514 # 800083e0 <states.1714+0x1a0>
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  if(writable){
    ...
    80003ea4:	842080e7          	jalr	-1982(ra) # 800016e2 <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003eda:	80c080e7          	jalr	-2036(ra) # 800016e2 <wakeup>
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    80003f10:	f86080e7          	jalr	-122(ra) # 80000e92 <myproc>
  ...
  return i;
    ...
    80003f62:	784080e7          	jalr	1924(ra) # 800016e2 <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    80003f66:	85de                	mv	a1,s7
    80003f68:	8562                	mv	a0,s8
    80003f6a:	ffffd097          	auipc	ra,0xffffd
    80003f6e:	5ec080e7          	jalr	1516(ra) # 80001556 <sleep>
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    80004004:	e92080e7          	jalr	-366(ra) # 80000e92 <myproc>
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    8000403a:	520080e7          	jalr	1312(ra) # 80001556 <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    ...
    80004084:	ad4080e7          	jalr	-1324(ra) # 80000b54 <copyout>
  ...
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    ...
    8000409c:	64a080e7          	jalr	1610(ra) # 800016e2 <wakeup>
  release(&pi->lock);
...
exec(char *path, char **argv)
{
  ...
  struct proc *p = myproc();
    ...
    80004104:	d92080e7          	jalr	-622(ra) # 80000e92 <myproc>
 ...
 bad:
  ...
  if((pagetable = proc_pagetable(p)) == 0)
    ...
    800041a0:	dba080e7          	jalr	-582(ra) # 80000f56 <proc_pagetable>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    800041c6:	61650513          	addi	a0,a0,1558 # 800087d8 <syscall_names+0x288>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004208:	34c080e7          	jalr	844(ra) # 80000550 <walkaddr>
  ...
  p = myproc();
    ...
    80004232:	c64080e7          	jalr	-924(ra) # 80000e92 <myproc>
  ...
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    ...
    80004258:	6b0080e7          	jalr	1712(ra) # 80000904 <uvmalloc>
  ...
  uvmclear(pagetable, sz-2*PGSIZE);
    ...
    8000426e:	8b8080e7          	jalr	-1864(ra) # 80000b22 <uvmclear>
  stackbase = sp - PGSIZE;
  ...
  sp = sz;
    ...
    8000428c:	0be080e7          	jalr	190(ra) # 80000346 <strlen>
    ...
    800042ac:	09e080e7          	jalr	158(ra) # 80000346 <strlen>
    ...
    800042be:	89a080e7          	jalr	-1894(ra) # 80000b54 <copyout>
  ...
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    ...
    80004320:	838080e7          	jalr	-1992(ra) # 80000b54 <copyout>
  ...
  safestrcpy(p->name, last, sizeof(p->name));
    ...
    80004362:	fb6080e7          	jalr	-74(ra) # 80000314 <safestrcpy>
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    ...
    80004432:	4d6080e7          	jalr	1238(ra) # 80000904 <uvmalloc>
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  if(argint(n, &fd) < 0)
    ...
    80004474:	b2a080e7          	jalr	-1238(ra) # 80001f9a <argint>
  ...
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    8000448a:	a0c080e7          	jalr	-1524(ra) # 80000e92 <myproc>
...
fdalloc(struct file *f)
{
  ...
  struct proc *p = myproc();
    ...
    800044d4:	9c2080e7          	jalr	-1598(ra) # 80000e92 <myproc>
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    800045f8:	20450513          	addi	a0,a0,516 # 800087f8 <syscall_names+0x2a8>
    ...
    8000461e:	1ee58593          	addi	a1,a1,494 # 80008808 <syscall_names+0x2b8>
    ...
    80004638:	1dc58593          	addi	a1,a1,476 # 80008810 <syscall_names+0x2c0>
    ...
    8000464e:	1ce50513          	addi	a0,a0,462 # 80008818 <syscall_names+0x2c8>
    80004652:	00001097          	auipc	ra,0x1
    80004656:	636080e7          	jalr	1590(ra) # 80005c88 <panic>
    panic("create: dirlink");
    8000465a:	00004517          	auipc	a0,0x4
    8000465e:	1ce50513          	addi	a0,a0,462 # 80008828 <syscall_names+0x2d8>
...
00000000800046bc <sys_read>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    800046e4:	8ba080e7          	jalr	-1862(ra) # 80001f9a <argint>
    return -1;
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    800046f8:	8c8080e7          	jalr	-1848(ra) # 80001fbc <argaddr>
    return -1;
...
0000000080004722 <sys_write>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    8000474a:	854080e7          	jalr	-1964(ra) # 80001f9a <argint>
    return -1;
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    8000475e:	862080e7          	jalr	-1950(ra) # 80001fbc <argaddr>
    return -1;
...
0000000080004788 <sys_close>:
{
  ...
  myproc()->ofile[fd] = 0;
    ...
    800047ac:	6ea080e7          	jalr	1770(ra) # 80000e92 <myproc>
...
00000000800047d6 <sys_fstat>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    ...
    800047fe:	7c2080e7          	jalr	1986(ra) # 80001fbc <argaddr>
    return -1;
...
0000000080004824 <sys_link>:
{
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    8000483e:	7a4080e7          	jalr	1956(ra) # 80001fde <argstr>
    return -1;
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    80004856:	78c080e7          	jalr	1932(ra) # 80001fde <argstr>
    return -1;
...
000000008000496e <sys_unlink>:
{
  ...
  if(argstr(0, path, MAXPATH) < 0)
    ...
    8000498a:	658080e7          	jalr	1624(ra) # 80001fde <argstr>
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    800049ba:	e5258593          	addi	a1,a1,-430 # 80008808 <syscall_names+0x2b8>
    ...
    800049d2:	e4258593          	addi	a1,a1,-446 # 80008810 <syscall_names+0x2c0>
  ...
  memset(&de, 0, sizeof(de));
    ...
    80004a24:	7a2080e7          	jalr	1954(ra) # 800001c2 <memset>
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
  ...
  return 0;
    ...
    80004a92:	daa50513          	addi	a0,a0,-598 # 80008838 <syscall_names+0x2e8>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80004ade:	d7650513          	addi	a0,a0,-650 # 80008850 <syscall_names+0x300>
    80004ae2:	00001097          	auipc	ra,0x1
    80004ae6:	1a6080e7          	jalr	422(ra) # 80005c88 <panic>
    panic("unlink: writei");
    80004aea:	00004517          	auipc	a0,0x4
    80004aee:	d7e50513          	addi	a0,a0,-642 # 80008868 <syscall_names+0x318>
...
sys_open(void)
{
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    80004b5c:	486080e7          	jalr	1158(ra) # 80001fde <argstr>
    return -1;
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    80004b70:	42e080e7          	jalr	1070(ra) # 80001f9a <argint>
...
sys_mkdir(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80004cf6:	2ec080e7          	jalr	748(ra) # 80001fde <argstr>
...
sys_mknod(void)
{
  ...
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    80004d56:	28c080e7          	jalr	652(ra) # 80001fde <argstr>
    ...
    80004d68:	236080e7          	jalr	566(ra) # 80001f9a <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    80004d7a:	224080e7          	jalr	548(ra) # 80001f9a <argint>
     argint(1, &major) < 0 ||
...
sys_chdir(void)
{
  ...
  struct proc *p = myproc();
    ...
    80004dd0:	0c6080e7          	jalr	198(ra) # 80000e92 <myproc>
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    ...
    80004dec:	1f6080e7          	jalr	502(ra) # 80001fde <argstr>
...
sys_exec(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80004e88:	15a080e7          	jalr	346(ra) # 80001fde <argstr>
    return -1;
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80004e9c:	124080e7          	jalr	292(ra) # 80001fbc <argaddr>
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80004eb2:	314080e7          	jalr	788(ra) # 800001c2 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80004ed8:	02c080e7          	jalr	44(ra) # 80001f00 <fetchaddr>
    ...
    80004f00:	056080e7          	jalr	86(ra) # 80001f52 <fetchstr>
...
sys_pipe(void)
{
  ...
  struct proc *p = myproc();
    ...
    80004f84:	f12080e7          	jalr	-238(ra) # 80000e92 <myproc>
  ...
  if(argaddr(0, &fdarray) < 0)
    ...
    80004f94:	02c080e7          	jalr	44(ra) # 80001fbc <argaddr>
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80004ff0:	b68080e7          	jalr	-1176(ra) # 80000b54 <copyout>
    ...
    8000500a:	b4e080e7          	jalr	-1202(ra) # 80000b54 <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
0000000080005090 <kernelvec>:
    ...
    800050d0:	cfdfc0ef          	jal	ra,80001dcc <kerneltrap>
...
plicinithart(void)
{
  ...
  int hart = cpuid();
    ...
    8000516c:	cfe080e7          	jalr	-770(ra) # 80000e66 <cpuid>
...
plic_claim(void)
{
  ...
  int hart = cpuid();
    ...
    800051a4:	cc6080e7          	jalr	-826(ra) # 80000e66 <cpuid>
...
plic_complete(int irq)
{
  ...
  int hart = cpuid();
    ...
    800051cc:	c9e080e7          	jalr	-866(ra) # 80000e66 <cpuid>
...
free_desc(int i)
{
  ...
  wakeup(&disk.free[0]);
    ...
    80005256:	490080e7          	jalr	1168(ra) # 800016e2 <wakeup>
}
    ...
    80005266:	61650513          	addi	a0,a0,1558 # 80008878 <syscall_names+0x328>
    8000526a:	00001097          	auipc	ra,0x1
    8000526e:	a1e080e7          	jalr	-1506(ra) # 80005c88 <panic>
    panic("free_desc 2");
    80005272:	00003517          	auipc	a0,0x3
    80005276:	61650513          	addi	a0,a0,1558 # 80008888 <syscall_names+0x338>
...
0000000080005282 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005290:	60c58593          	addi	a1,a1,1548 # 80008898 <syscall_names+0x348>
  ...
  *R(VIRTIO_MMIO_QUEUE_NUM) = NUM;
  ...
  memset(disk.pages, 0, sizeof(disk.pages));
    ...
    80005338:	e8e080e7          	jalr	-370(ra) # 800001c2 <memset>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  while(1){
    ...
    80005496:	0c4080e7          	jalr	196(ra) # 80001556 <sleep>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    800055e0:	f7a080e7          	jalr	-134(ra) # 80001556 <sleep>
  while(b->disk == 1) {
...
virtio_disk_intr()
{
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    8000571e:	fc8080e7          	jalr	-56(ra) # 800016e2 <wakeup>
  ...
  release(&disk.vdisk_lock);
    ...
    8000575a:	1b250513          	addi	a0,a0,434 # 80008908 <syscall_names+0x3b8>
...
00000000800057d8 <start>:
{
  ...
  asm volatile("csrw mepc, %0" : : "r" (x));
    ...
    800057fc:	b7878793          	addi	a5,a5,-1160 # 80000370 <main>
...
consolewrite(int user_src, uint64 src, int n)
{
  ...
  for(i = 0; i < n; i++){
    ...
    8000587a:	0da080e7          	jalr	218(ra) # 80001950 <either_copyin>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  while(n > 0){
    ...
    80005912:	584080e7          	jalr	1412(ra) # 80000e92 <myproc>
    ...
    80005922:	c38080e7          	jalr	-968(ra) # 80001556 <sleep>
    while(cons.r == cons.w){
    ...
    8000595e:	fa0080e7          	jalr	-96(ra) # 800018fa <either_copyout>
...
consoleintr(int c)
{
  ...
  case C('P'):  // Print process list.
    ...
    80005a40:	f6a080e7          	jalr	-150(ra) # 800019a6 <procdump>
      }
    }
    break;
  }
  ...
  switch(c){
    ...
    80005b94:	b52080e7          	jalr	-1198(ra) # 800016e2 <wakeup>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80005ba6:	d7e58593          	addi	a1,a1,-642 # 80008920 <syscall_names+0x3d0>
...
panic(char *s)
{
  ...
  printf("panic: ");
    ...
    80005ca0:	c8c50513          	addi	a0,a0,-884 # 80008928 <syscall_names+0x3d8>
...
0000000080005cd2 <printf>:
{
  ...
  consputc('x');
    ...
    80005d58:	be450513          	addi	a0,a0,-1052 # 80008938 <syscall_names+0x3e8>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    80005e58:	adc90913          	addi	s2,s2,-1316 # 80008930 <syscall_names+0x3e0>
      for(; *s; s++)
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    80005ece:	a7e58593          	addi	a1,a1,-1410 # 80008948 <syscall_names+0x3f8>
    ...
    80005f9a:	06e78c63          	beq	a5,a4,80006012 <uartstart+0x88>
{
    ...
    80005fee:	6f8080e7          	jalr	1784(ra) # 800016e2 <wakeup>
...
0000000080006014 <uartputc>:
{
  ...
  if(panicked){
    ...
    8000607a:	4e0080e7          	jalr	1248(ra) # 80001556 <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    ...
    8000615e:	8082                	ret
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    ...
    80006170:	d0a080e7          	jalr	-758(ra) # 80000e76 <mycpu>
...
push_off(void)
{
  ...
  mycpu()->noff += 1;
    ...
    800061c6:	cb4080e7          	jalr	-844(ra) # 80000e76 <mycpu>
  return (x & SSTATUS_SIE) != 0;
...
00000000800061d2 <acquire>:
{
  ...
  lk->cpu = mycpu();
    ...
    80006206:	c74080e7          	jalr	-908(ra) # 80000e76 <mycpu>
...
pop_off(void)
{
  ...
  struct cpu *c = mycpu();
    ...
    80006232:	c48080e7          	jalr	-952(ra) # 80000e76 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
